...
void CalcStructKalman(struct22_T *StructKalman, float Ta, emxArray_real_T *t,
                      const emxArray_real_T *i_in, const emxArray_real_T *v_out)
{
  ...
  for (loop_ub = 0; loop_ub < i; loop_ub++) {
    ...
    StructKalman->P_k_k[loop_ub] = CellKalman(
        b_StructKalman, c_StructKalman, StructKalman->P_k_k[loop_ub], Ta,
        t_data[loop_ub],
        (float)t_data[loop_ub] - StructKalman->BatState_k_k[loop_ub + 288],
