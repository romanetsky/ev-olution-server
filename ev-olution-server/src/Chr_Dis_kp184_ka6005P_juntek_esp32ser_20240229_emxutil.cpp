 ...
 * File: Chr_Dis_kp184_ka6005P_juntek_esp32ser_20240229_emxutil.c
 *
...
/*
 * Arguments    : struct30_T *pStruct
 * Return Type  : void
 */
void emxFreeStruct_struct30_T(struct30_T *pStruct)
{
  emxFree_real_T(&pStruct->VbusTest);
  emxFree_real_T(&pStruct->VmKp184Test);
}
 ...
 * Return Type  : void
 */
void emxInitStruct_struct30_T(struct30_T *pStruct)
{
  emxInit_real_T(&pStruct->VbusTest, 2);
  emxInit_real_T(&pStruct->VmKp184Test, 2);
}
...
/*
 * File trailer for Chr_Dis_kp184_ka6005P_juntek_esp32ser_20240229_emxutil.c
 *
 * [EOF]
 */
